...
namespace Cyclamen.Mobile.Repositories.Cars
{
    public class CarRepository : ICarRepository
    {
        ...
        public async Task<List<Wheels>> GetWheels()
            => await _connection.Table<Wheels>().ToListAsync();
        ...
        public async Task<Wheels> GetWheel(int id)
            => await _connection.GetAsync<Wheels>(id);
